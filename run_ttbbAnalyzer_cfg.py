...
process = cms.Process("ttbbAnalyzer")
...
process.source.fileNames = ['file:/xrootd/store/group/CAT/TT_TuneCUETP8M1_13TeV-powheg-pythia8/v8-0-3_RunIISpring16MiniAODv2-PUSpring16RAWAODSIM_reHLT_80X_mcRun2_asymptotic_v14_ext3-v1/161205_142558/0000/catTuple_1.root',]
...
process.cattree = cms.EDAnalyzer("ttbbAnalyzer",
    ...
    puweight = cms.InputTag("redoPileupWeight"),
    puweightUp = cms.InputTag("redoPileupWeight","up"),
