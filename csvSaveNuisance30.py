...
rootdir = "/xrootd/store/user/chanwook/ttbb/final/pt25/"
...
for sys,d in enumerate(mceventweight):
  ...
  for ch in range(3):
    if d["name"]=="PU_Up": PUweight = "weight*puweightUp"
    elif d["name"]=="PU_Down": PUweight = "weight*puweightDown"
