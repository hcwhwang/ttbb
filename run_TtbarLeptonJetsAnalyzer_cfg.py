...
process = cms.Process("TtbarLeptonJetsAnalyzer")
...
'''
process.cattree = cms.EDAnalyzer("TtbarLeptonJetsAnalyzer",
    ...
    trigMUJETS = cms.InputTag("filterTrigMU"),
    trigELJETS = cms.InputTag("filterTrigEL"),
    ...
    #GenTop = cms.InputTag("catGenTops","","TtbarLeptonJetsAnalyzer"),
)
